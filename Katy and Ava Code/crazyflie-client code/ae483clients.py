...
class CrazyflieClient:
    ...
    def movesmooth_and_rotate(self, p_inW_1, p_inW_2, yaw, pitch, roll, v):
        ...
        while True:
            ...
            elif start_time <= t and t <= start_time+dt:
                s = (t-start_time) / dt
                print(s)
            else:
                s = 1          # <-- FIXME (C)
            ...
            self.cf.commander.send_position_setpoint(p_inW_des[0], p_inW_des[1], p_inW_des[2], yaw, pitch, roll)
